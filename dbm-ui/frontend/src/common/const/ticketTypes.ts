...
export enum TicketTypes {
  ...
  MYSQL_ADD_CLB = 'MYSQL_ADD_CLB', // 启用clb
  MYSQL_ADD_SLAVE = 'MYSQL_ADD_SLAVE',
  MYSQL_AUTHORIZE_RULES = 'MYSQL_AUTHORIZE_RULES',
  MYSQL_CHECKSUM = 'MYSQL_CHECKSUM',
  MYSQL_CHECKSUM_CRON = 'MYSQL_CHECKSUM_CRON', // MySQL checksum 定时任务
  MYSQL_CLB_BIND_DOMAIN = 'MYSQL_CLB_BIND_DOMAIN', // 主域名指向CLB ip
  MYSQL_CLB_UNBIND_DOMAIN = 'MYSQL_CLB_UNBIND_DOMAIN', // 解绑主域名指向clb
  MYSQL_CLIENT_CLONE_RULES = 'MYSQL_CLIENT_CLONE_RULES',
  MYSQL_CLUSTER_STANDARDIZE = 'MYSQL_CLUSTER_STANDARDIZE', // 集群标准化
  MYSQL_DATA_MIGRATE = 'MYSQL_DATA_MIGRATE',
  MYSQL_DATA_REPAIR = 'MYSQL_DATA_REPAIR', // mysql 数据修复
  MYSQL_DELETE_CLEAR_DB = 'MYSQL_DELETE_CLEAR_DB',
  MYSQL_DTS_DATA_MIGRATE = 'MYSQL_DTS_DATA_MIGRATE', // MySQL DTS 同名迁移
  MYSQL_DTS_DATA_MIGRATE_RENAME = 'MYSQL_DTS_DATA_MIGRATE_RENAME', // MySQL DTS 库改名迁移
  MYSQL_DUMP_DATA = 'MYSQL_DUMP_DATA', // mysql 数据导出
  MYSQL_EXCEL_AUTHORIZE_RULES = 'MYSQL_EXCEL_AUTHORIZE_RULES',
  MYSQL_FIXPOINT_EXIST_CLUSTER = 'MYSQL_FIXPOINT_EXIST_CLUSTER', // mysql 构造到已有集群
  MYSQL_FIXPOINT_NEW_CLUSTER = 'MYSQL_FIXPOINT_NEW_CLUSTER', // mysql 构造到新集群
  ...
  MYSQL_HA_RENAME_DATABASE = 'MYSQL_HA_RENAME_DATABASE', // 老单据
  ...
  MYSQL_INSTANCE_FAIL_OVER = 'MYSQL_INSTANCE_FAIL_OVER', // MySQL 实例故障切换
  ...
  MYSQL_MIGRATE_SINGLE = 'MYSQL_MIGRATE_SINGLE', // MySQL 单节点迁移
  MYSQL_MIGRATE_UPGRADE = 'MYSQL_MIGRATE_UPGRADE', // MySQL 迁移升级
  MYSQL_OPEN_AREA = 'MYSQL_OPEN_AREA', // 开区
  MYSQL_PARTITION = 'MYSQL_PARTITION',
  MYSQL_PARTITION_V2 = 'MYSQL_PARTITION_V2',
  MYSQL_PROXY_ADD = 'MYSQL_PROXY_ADD',
  MYSQL_PROXY_CONF_CHANGE = 'MYSQL_PROXY_CONF_CHANGE', // MySQL 升降配
  MYSQL_PROXY_MIGRATE = 'MYSQL_PROXY_MIGRATE', // MySQL 迁移
  MYSQL_PROXY_MIGRATE_INS = 'MYSQL_PROXY_MIGRATE_INS', // 迁移 Proxy （按实例）
  MYSQL_PROXY_REBUILD = 'MYSQL_PROXY_REBUILD', // MySQL Proxy 原地重建
  MYSQL_PROXY_REDUCE = 'MYSQL_PROXY_REDUCE', // 缩容proxy
  MYSQL_PROXY_RESCUE = 'MYSQL_PROXY_RESCUE', // MySQL Proxy 灾难重建（整组不可用，按集群整组申请新机重建并下架旧机）
  MYSQL_PROXY_SWITCH = 'MYSQL_PROXY_SWITCH',
  MYSQL_PROXY_UPGRADE = 'MYSQL_PROXY_UPGRADE', // MySQL Proxy 升级
  MYSQL_RENAME_DATABASE = 'MYSQL_RENAME_DATABASE',
  MYSQL_RESTORE_LOCAL_SLAVE = 'MYSQL_RESTORE_LOCAL_SLAVE',
  MYSQL_RESTORE_SLAVE = 'MYSQL_RESTORE_SLAVE',
  MYSQL_ROLLBACK = 'MYSQL_ROLLBACK', // mysql 回档
  MYSQL_ROLLBACK_CLUSTER = 'MYSQL_ROLLBACK_CLUSTER',
  MYSQL_SEMANTIC_CHECK = 'MYSQL_SEMANTIC_CHECK', // 模拟执行
  ...
  MYSQL_SINGLE_RENAME_DATABASE = 'MYSQL_SINGLE_RENAME_DATABASE', // 老单据
...
export enum TicketTypes {
  ...
  REDIS_CLUSTER_REINSTALL_DBMON = 'REDIS_CLUSTER_REINSTALL_DBMON', // redis 集群标准化
  ...
  REDIS_HOT_KEY_ANALYSIS = 'REDIS_HOT_KEY_ANALYSIS',
  ...
  // REDIS_PROXY_FAST_FIX = 'REDIS_PROXY_FAST_FIX',
  REDIS_PROXY_FIX = 'REDIS_PROXY_FIX',
  REDIS_PROXY_KICKOFF = 'REDIS_PROXY_KICKOFF',
  ...
  REDIS_SHARD_ADD = 'REDIS_SHARD_ADD', //  Redis 集群分片变更（Slot迁移）, 增加分片数
  REDIS_SHARD_REDUCE = 'REDIS_SHARD_REDUCE', //  Redis 集群分片变更（Slot迁移）, 减少分片数
...
export enum TicketTypes {
  ...
  TENDBCLUSTER_ADD_CLB = 'TENDBCLUSTER_ADD_CLB', // 启用clb
  ...
  TENDBCLUSTER_CHECKSUM_CRON = 'TENDBCLUSTER_CHECKSUM_CRON', // Spider checksum 定时任务
  TENDBCLUSTER_CLB_BIND_DOMAIN = 'TENDBCLUSTER_CLB_BIND_DOMAIN', // 主域名指向CLB ip
  TENDBCLUSTER_CLB_UNBIND_DOMAIN = 'TENDBCLUSTER_CLB_UNBIND_DOMAIN', // 解绑主域名指向clb
  TENDBCLUSTER_CLIENT_CLONE_RULES = 'TENDBCLUSTER_CLIENT_CLONE_RULES', // Spider 客户端权限克隆
  TENDBCLUSTER_CLUSTER_STANDARDIZE = 'TENDBCLUSTER_CLUSTER_STANDARDIZE', // 集群标准化
  ...
  TENDBCLUSTER_DELETE_CLEAR_DB = 'TENDBCLUSTER_DELETE_CLEAR_DB',
  ...
  TENDBCLUSTER_FIXPOINT_EXIST = 'TENDBCLUSTER_FIXPOINT_EXIST', // tendbcluster 构造到已有集群
  TENDBCLUSTER_FIXPOINT_NEW = 'TENDBCLUSTER_FIXPOINT_NEW', // tendbcluster 构造到新集群
  ...
  TENDBCLUSTER_INSTANCE_FAIL_OVER = 'TENDBCLUSTER_INSTANCE_FAIL_OVER', // Spider remote主库故障实例切换
  TENDBCLUSTER_LOCAL_UPGRADE = 'TENDBCLUSTER_LOCAL_UPGRADE', // spider 接入层 原地升级
  TENDBCLUSTER_MASTER_FAIL_OVER = 'TENDBCLUSTER_MASTER_FAIL_OVER', // Spider remote主库故障切换
  ...
  TENDBCLUSTER_MIGRATE_UPGRADE = 'TENDBCLUSTER_MIGRATE_UPGRADE', // tendbcluster 迁移升级
  ...
  TENDBCLUSTER_REMOTE_UPGRADE = 'TENDBCLUSTER_REMOTE_UPGRADE', // spider 存储层 原地升级
  ...
  TENDBCLUSTER_ROLLBACK = 'TENDBCLUSTER_ROLLBACK', // tendbcluster 回档,
  ...
  TENDBCLUSTER_SPIDER_CONF_UP_DOWN = 'TENDBCLUSTER_SPIDER_CONF_UP_DOWN', // spider 升降配
  TENDBCLUSTER_SPIDER_LAYER_DR = 'TENDBCLUSTER_SPIDER_LAYER_DR', // Spider 接入层灾难重建（整组不可用，按集群整组申请新机重建并下架旧机）
  ...
  TENDBCLUSTER_SPIDER_REBUILD = 'TENDBCLUSTER_SPIDER_REBUILD', // Spider 接入层原地重建
  ...
  TENDBCLUSTER_SPIDER_SWITCH_NODES = 'TENDBCLUSTER_SPIDER_SWITCH_NODES', // Spider 替换接入层
  TENDBCLUSTER_SPIDER_UPGRADE = 'TENDBCLUSTER_SPIDER_UPGRADE', // spider 接入层 迁移升级
...
export enum TicketTypes {
  ...
  MONGODB_INSTANCE_FIX_STATUS = 'MONGODB_INSTANCE_FIX_STATUS', // Mongos 状态修复
  ...
  MONGODB_REPLICASET_CUTOFF = 'MONGODB_REPLICASET_CUTOFF', // mongo 副本集群整机替换
  MONGODB_REPLICASET_MIGRATE = 'MONGODB_REPLICASET_MIGRATE', // MongoDB 副本集群迁移
  MONGODB_RESTORE = 'MONGODB_RESTORE', // mongo 定点构造
  MONGODB_SCALE_UPDOWN = 'MONGODB_SCALE_UPDOWN', // MongoDB 分片式集群单个容量变更
  MONGODB_SHARD_ADD_SHARD_NODES = 'MONGODB_SHARD_ADD_SHARD_NODES', // mongo 分片集群扩容 shard 节点数
...
export enum TicketTypes {
  ...
  SQLSERVER_CLUSTER_MIGRATE = 'SQLSERVER_CLUSTER_MIGRATE', // sqlserver 集群迁移
  SQLSERVER_DATA_EXPORT = 'SQLSERVER_DATA_EXPORT', // sqlserver 数据导出
  ...
  SQLSERVER_HOST_MIGRATE = 'SQLSERVER_HOST_MIGRATE', // sqlserver 整机迁移
...
export enum TicketTypes {
  ...
  ES_DELETE_CLB = 'ES_DELETE_CLB',
  ES_DELETE_POLARIS = 'ES_DELETE_POLARIS',
  ES_DESTROY = 'ES_DESTROY',
  ES_DISABLE = 'ES_DISABLE',
  ES_DNS_BIND_CLB = 'ES_DNS_BIND_CLB', // 主域名指向CLB ip
  ES_DNS_UNBIND_CLB = 'ES_DNS_UNBIND_CLB', // 解绑主域名指向clb
  ES_ENABLE = 'ES_ENABLE',
  ES_REBOOT = 'ES_REBOOT',
...
export enum TicketTypes {
  ...
  KAFKA_REBALANCE = 'KAFKA_REBALANCE', // kafka topic 均衡
...
export enum TicketTypes {
  K8S_SURREALDB_DELETE = 'K8S_SURREALDB_DELETE', // SurrealDB 删除
  K8S_SURREALDB_DISABLE = 'K8S_SURREALDB_DISABLE', // SurrealDB 禁用
  K8S_SURREALDB_ENABLE = 'K8S_SURREALDB_ENABLE', // SurrealDB 启用
  K8S_SURREALDB_HA_APPLY = 'K8S_SURREALDB_HA_APPLY', // SurrealDB 主从集群申请
  K8S_SURREALDB_RESTART = 'K8S_SURREALDB_RESTART', // SurrealDB 重启
  K8S_SURREALDB_SINGLE_APPLY = 'K8S_SURREALDB_SINGLE_APPLY', // SurrealDB 单节点集群申请
}
export enum TicketTypes {
  K8S_QDRANT_DELETE = 'K8S_QDRANT_DELETE', // Qdrant 删除
  K8S_QDRANT_DISABLE = 'K8S_QDRANT_DISABLE', // Qdrant 禁用
  K8S_QDRANT_ENABLE = 'K8S_QDRANT_ENABLE', // Qdrant 启用
  K8S_QDRANT_HA_APPLY = 'K8S_QDRANT_HA_APPLY', // Qdrant 集群申请
  K8S_QDRANT_RESTART = 'K8S_QDRANT_RESTART', // Qdrant 重启
}
export enum TicketTypes {

  ...
  <tr>
    ...
    <td
      ...
      <RenderHostInputSelect
        ...
        :host-data="localHostData.remote_hosts" />
    </td>
    <td
      v-if="showHostColumn"
      style="padding: 0">
      ...
      <RenderHostInputSelect
        ref="spiderHostRef"
        :cluster-data="localClusterData"
        :host-data="[localHostData.spider_host]"
        single />
    </td>
    <td
...
<script lang="ts">
  ...
  import { BackupSources, BackupTypes } from '../../const';
...
<script setup lang="ts">
  ...
  import RenderMode from '@views/db-manage/mysql/rollback/pages/page1/components/render-row/components/render-mode/Index.vue';
  import RenderBackup from '@views/db-manage/mysql/rollback/pages/page1/components/render-row/components/RenderBackup.vue';
  import RenderCluster from '@views/db-manage/mysql/rollback/pages/page1/components/render-row/components/RenderCluster.vue';
  import RenderClusterInputSelect from '@views/db-manage/mysql/rollback/pages/page1/components/render-row/components/RenderClusterInputSelect.vue';
  import RenderHostInputSelect from '@views/db-manage/mysql/rollback/pages/page1/components/render-row/components/RenderHostInputSelect.vue';
  import RenderHostSource from '@views/db-manage/mysql/rollback/pages/page1/components/render-row/components/RenderHostSource.vue';
  ...
  const configMap = {
    [RollbackClusterTypes.BUILD_INTO_NEW_CLUSTER]: ['host', 'dbTableIgnore', 'operate'],
  ...
  watch(
    ...
    () => {
      ...
      if (props.data.rollbackHost) {
        localHostData.remote_hosts = props.data.rollbackHost.remote_hosts;
        localHostData.spider_host = props.data.rollbackHost.spider_host;
      }
